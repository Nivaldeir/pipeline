  ...
  return (
    <div className="flex flex-col h-[500px] border border-border rounded-lg bg-card">
      <div className="px-4 py-3 border-b border-border">
        <h3 className="font-medium text-foreground">Comentários do Projeto</h3>
        <p className="text-xs text-muted-foreground">{comments.length} mensagens</p>
      </div>
                              ...
                              <DropdownMenuTrigger asChild>
                                <Button
                                  ...
                                  className={cn(
                                    ...
                                    isOwn ? "bg-primary-foreground/10 hover:bg-primary-foreground/20" : "bg-secondary-foreground/10 hover:bg-secondary-foreground/20"
                                  )}
                                >
